...
deploy-sepolia: 
	...
	@forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_TEST_URL) --private-key $(SEPOLIA_PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(SEPOLIA_API_KEY) -vvvv
